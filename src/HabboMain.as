package
{
   ...
   public class HabboMain extends Sprite implements IHabboMain
   {
      ...
      private var var_1504:ICoreConfigStatusListener;
      ...
      private function initCore(param1:String, param2:uint) : void
      {
         ...
         var_689.loadExternalConfigDocument(new URLRequest(param1),var_1504);
      }
      ...
      protected function onStageInit(param1:Event = null) : void
      {
         ...
         initCore("config_habbo.xml",Core.const_956);
      }
      ...
      public function initializeCore() : void
      {
         ...
         {
            Core.crash("Failed to initialize the core: " + error.message,CoreComponent.const_1169,error);
         }
      }
