package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_470 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_659))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_659,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_98 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_659,"EOF"));
            }
         }
      }
      ...
      {
         if(var_470.parse(param1))
         {
            var_52.push(var_470);
            if(false)
            {
               var_144["null"] = var_470;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1286,var_470));
            var_470 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_52 != null && var_144 != null && param1 < var_52.length)
         {
