package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1349:uint = 1;
      
      protected static const const_1547:int = 5;
      
      protected static const const_1047:uint = 7;
      
      protected static const const_1348:uint = 4;
      
      protected static const const_1347:uint = 3;
      ...
      protected var var_407:uint = 0;
      
      protected var var_1:Loader;
      
      protected var var_2131:String = "";
      
      protected var var_346:URLRequest;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_449 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_345 + " for file \"" + var_1.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
         ...
         if(var_407 == LibraryLoader.const_1347)
         {
            if(analyzeLibrary())
            {
               var_407 |= 0;
         ...
         if(var_407 == LibraryLoader.const_1047)
         {
            var_1280 = true;
            prepareLibrary();
            removeEventListeners();
