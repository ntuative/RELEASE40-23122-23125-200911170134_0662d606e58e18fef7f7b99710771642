package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_791:uint = 256;
      ...
      public static const const_1468:uint = 128;
      
      public static const const_1475:uint = 64;
      
      public static const const_671:uint = 4;
      
      public static const const_1196:uint = 0;
      
      public static const const_1142:uint = 16;
      
      public static const const_498:uint = 1;
      
      public static const const_1251:uint = 8;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_955:
               ...
               break;
            case GraphicContext.const_1251:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1142:
            ...
            case GraphicContext.const_791:
               break;
            case GraphicContext.const_1196:
               break;
            default:
      ...
      {
         return method_1().addChildAt(param1 as DisplayObject,param2) as IGraphicContext;
      }
      ...
      {
         method_1().swapChildren(param1 as DisplayObject,param2 as DisplayObject);
      }
      
      public function removeChildContext(param1:IGraphicContext) : IGraphicContext
      {
         return method_1().removeChild(DisplayObject(param1)) as IGraphicContext;
      }
      ...
      {
         method_1().swapChildrenAt(param1,param2);
      }
      ...
      protected function method_1() : DisplayObjectContainer
      {
         if(var_162 == null)
         {
            var_162 = new Sprite();
      ...
      {
         var _loc2_:IGraphicContext = method_1().getChildAt(param1) as IGraphicContext;
         return _loc2_ == null ? null : removeChildContext(_loc2_);
      }
      
      public function addChildContext(param1:IGraphicContext) : IGraphicContext
      {
         return method_1().addChild(param1 as DisplayObject) as IGraphicContext;
      }
      ...
      {
         return method_1().getChildByName(param1) as IGraphicContext;
      }
      ...
      public function setChildContextIndex(param1:IGraphicContext, param2:int) : void
      {
         ...
         if(dispObj != null)
         {
            try
            {
               current = method_1().getChildIndex(dispObj);
            }
            ...
            if(index != current)
            {
               method_1().setChildIndex(dispObj,index);
            }
            return;
         }
      ...
      {
         return method_1().getChildIndex(DisplayObject(param1));
      }
      ...
      {
         return method_1().getChildAt(param1) as IGraphicContext;
      }
