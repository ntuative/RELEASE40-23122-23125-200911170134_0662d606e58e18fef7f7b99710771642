package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2025 = new Dictionary();
         TypeCodeTable.fillTables(var_1449,var_2025);
         var_1213 = new Dictionary();
         var_2026 = new Dictionary();
         StateCodeTable.fillTables(var_1213,var_2026);
         ...
         {
            var_352 = new Array();
            var_352.push(WindowState.const_56);
            var_352.push(WindowState.const_66);
            var_352.push(WindowState.const_80);
            var_352.push(WindowState.const_47);
            var_352.push(WindowState.const_71);
            var_352.push(WindowState.const_69);
            var_352.push(WindowState.const_84);
            var_352.push(WindowState.const_74);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1213)
         {
            _loc3_.push(var_1213[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1449[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_547[param1] = new Array(SkinContainer.const_1080);
         }
