package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      public function ItemListController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         _container = _context.create("_CONTAINER","",WindowType.const_299,WindowStyle.const_243,0 | 0 | 0 | 0,_loc13_,null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_46,containerEventHandler);
         _container.addEventListener(WindowEvent.const_343,containerEventHandler);
         _container.addEventListener(WindowEvent.const_292,containerEventHandler);
         _container.addEventListener(WindowEvent.const_356,containerEventHandler);
         resizeOnItemUpdate = var_1025;
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_343,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_292,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_356,containerEventHandler);
         super.dispose();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("spacing",_spacing,PropertyStruct.const_81,_spacing != 0));
         _loc1_.push(new PropertyStruct("auto_arrange_items",var_686,PropertyStruct.const_57,var_686 != true));
         _loc1_.push(new PropertyStruct("scale_to_fit_items",var_486,PropertyStruct.const_57,var_486 != false));
         _loc1_.push(new PropertyStruct("resize_on_item_update",var_1025,PropertyStruct.const_57,var_1025 != false));
         return _loc1_;
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            ...
            {
               _container.setParamFlag(WindowParam.const_391,param1);
            }
         }
      }
