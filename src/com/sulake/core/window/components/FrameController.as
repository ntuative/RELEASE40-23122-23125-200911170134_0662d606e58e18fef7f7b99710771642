package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1036:String = "_TITLE";
      
      private static const const_1035:String = "_CONTENT";
      
      private static const const_1037:String = "_HEADER";
      ...
      private var var_1122:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1122 == null)
         {
            var_1122 = findChildByTag(const_1037) as IHeaderWindow;
            if(!var_1122)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1036) as ITextWindow;
            if(!_title)
            {
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_1035) as IWindowContainer;
            if(!var_33)
            {
