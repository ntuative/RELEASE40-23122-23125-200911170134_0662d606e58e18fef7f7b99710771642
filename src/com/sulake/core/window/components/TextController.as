package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_489:String = "none";
      ...
      protected var var_688:Boolean = false;
      ...
      {
         return new Rectangle(var_571 * maxScrollH,var_348 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_688)
         {
            context.removeLocalizationListener(var_236,this);
         }
         if(var_73 != null)
         {
            var_73.dispose();
      ...
      public function set text(param1:String) : void
      {
         ...
         var_236 = param1;
         if(var_236.charAt(0) == "$" && var_236.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_236.slice(2,var_236.indexOf("}")),this);
            var_688 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_234,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1304,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_437,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_234,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_437,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_234,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_81,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_614,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_234,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_614,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("margin_left",var_73.left,PropertyStruct.const_81,true));
         _loc1_.push(new PropertyStruct("margin_top",var_73.top,PropertyStruct.const_81,true));
         _loc1_.push(new PropertyStruct("margin_right",var_73.right,PropertyStruct.const_81,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_73.bottom,PropertyStruct.const_81,true));
         _loc1_.push(new PropertyStruct("auto_size",var_489,PropertyStruct.const_234,var_489 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_614,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_489 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_489 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_489 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_489 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
