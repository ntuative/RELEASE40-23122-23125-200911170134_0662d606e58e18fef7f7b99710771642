package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1434:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_333)
         {
            ...
            if(var_333)
            {
               var_333.addEventListener(WindowEvent.const_264,scrollBarEventProc);
               var_333.addEventListener(WindowEvent.const_211,scrollBarEventProc);
            }
         }
         return var_333;
      }
      ...
      override public function dispose() : void
      {
         if(var_333)
         {
            var_333.removeEventListener(WindowEvent.const_264,scrollBarEventProc);
            var_333.removeEventListener(WindowEvent.const_211,scrollBarEventProc);
            var_333 = null;
         }
         if(_cachedItemList)
         {
