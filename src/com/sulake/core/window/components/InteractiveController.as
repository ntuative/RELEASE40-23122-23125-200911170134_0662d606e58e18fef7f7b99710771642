package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2135:uint = 0;
      
      protected var var_861:String = "";
      
      protected var var_408:Array;
      
      protected var var_860:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         param5 |= 0;
         var_408 = new Array();
         var_408[0] = MouseCursorType.const_298;
         var_408[1] = MouseCursorType.const_38;
         var_408[2] = MouseCursorType.const_298;
         var_408[3] = MouseCursorType.const_298;
         var_408[4] = MouseCursorType.const_38;
         var_408[5] = MouseCursorType.const_38;
         var_408[6] = MouseCursorType.const_298;
         if(var_307 == null)
         {
            var_307 = new Array();
            var_307[0] = WindowState.const_84;
            var_307[1] = WindowState.const_69;
            var_307[2] = WindowState.const_71;
            var_307[3] = WindowState.const_56;
            var_307[4] = WindowState.const_47;
            var_307[5] = WindowState.const_80;
         ...
         while(_loc5_ < _loc3_)
         {
            ...
            switch(_loc4_.key)
            {
               ...
               case "mouse_cursor_pressed":
                  param1.setMouseCursorByState(WindowState.const_80,_loc4_.value as uint);
                  break;
