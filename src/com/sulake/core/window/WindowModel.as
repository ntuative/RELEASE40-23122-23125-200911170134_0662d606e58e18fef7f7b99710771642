package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_685:Boolean;
      
      protected var var_147:Rectangle;
      
      protected var var_406:uint;
      ...
      public function WindowModel(param1:uint, param2:String, param3:String, param4:uint, param5:uint, param6:uint, param7:WindowContext, param8:Rectangle, param9:Array = null)
      {
         ...
         _type = param4;
         var_31 = param6;
         _state = WindowState.const_74;
         var_86 = param5;
         var_569 = param9 == null ? new Array() : param9;
         var_236 = param3;
         _context = param7;
         var_22 = param8.clone();
         var_344 = param8.clone();
         var_59 = param8.clone();
