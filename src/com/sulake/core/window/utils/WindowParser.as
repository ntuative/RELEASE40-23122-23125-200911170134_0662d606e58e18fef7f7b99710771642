package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_774:String = "_EXCLUDE";
      
      public static const const_1384:String = "_TEMP";
      
      private static const const_1071:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1070:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1028:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_855:Dictionary;
      
      protected var var_1286:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1285:Dictionary;
      
      protected var var_1027:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1028 = new Dictionary();
         TypeCodeTable.fillTables(var_1027,var_1028);
         var_855 = new Dictionary();
         var_1285 = new Dictionary();
         ParamCodeTable.fillTables(var_855,var_1285);
         var_1286 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1070,"");
         return param1.replace(const_1071,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1027)
            {
               delete var_1027[_loc1_];
            }
            for(_loc1_ in var_1028)
            {
               delete var_1028[_loc1_];
            }
            for(_loc1_ in var_855)
            {
               delete var_855[_loc1_];
            }
            for(_loc1_ in var_1285)
            {
               delete var_1285[_loc1_];
            }
            var_1286.dispose();
            var_1286 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_774) == -1)
                  {
