package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      private static var var_1073:uint = 0;
      ...
      protected var var_566:Function;
      ...
      protected var var_483:uint;
      
      protected var var_30:IGraphicContext;
      
      protected var var_302:Boolean;
      ...
      public function WindowController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         if(_loc13_ != null)
         {
            var_344 = new Rectangle(0,0,int(_loc13_.attribute("width")),int(_loc13_.attribute("height")));
            var_59 = var_344.clone();
            var_22 = var_344.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_104,WindowParam.const_141);
         var _loc2_:* = !testParamFlag(WindowParam.const_105,WindowParam.const_129);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_319)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_5 = param1;
         var_406 = !!var_5 ? uint(var_406 | _alphaColor) : uint(var_406 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_70);
      }
      
      public function destroy() : Boolean
      {
         if(_state == WindowState.const_354)
         {
            return true;
         }
         _state = WindowState.const_354;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1603 + "]";
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_30)
         {
            var_30 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_498,var_22);
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_22,WindowRedrawFlag.const_979);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_884 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_483);
      }
      
      public function set color(param1:uint) : void
      {
         _alphaColor = param1 & 4278190080;
         var_406 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_70);
      }
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_223:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_390,this,null));
                     if(testParamFlag(WindowParam.const_158,WindowParam.const_141))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_167,WindowParam.const_129))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_391))
                        {
                           var_23.height += 0 - 0;
                        }
                        var_31 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_217,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_373:
                  _context.invalidate(this,var_22.union(var_59),WindowRedrawFlag.const_467);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_818,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_239,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_272:
                  if(param1 == this)
                  {
                     ...
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_214,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_409:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_819);
                  break;
               case WindowNotifyEvent.const_421:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_352:
                  if(!(var_31 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_467);
                     }
                  }
                  else if(var_31 & 0)
                  {
      ...
      {
         return var_566 != null ? var_566 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_483);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_272;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_682,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_884 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_875,this,null,true);
               update(this,_loc10_);
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            else
            {
               ...
               var_278.width = 0;
               var_278.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_957,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_236,_type,var_86,var_31,_context,var_22,null,var_566,properties,var_569.concat(),_id) as WindowController;
         _loc2_.var_483 = var_483;
         _loc2_.var_302 = var_302;
         _loc2_.var_849 = var_849;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_555;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
