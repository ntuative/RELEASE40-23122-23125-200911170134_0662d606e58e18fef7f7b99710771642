   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(var_576 == const_725)
            {
               throw var_1294;
            }
            return var_576 == const_472;
         }
         return false;
      }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         var array:Array = var_239[event.type];
         ...
         var_576 = !!event.isDefaultPrevented() ? uint(const_995) : uint(const_472);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_239)
            {
               _loc2_ = var_239[_loc1_] as Array;
               for each(_loc3_ in _loc2_)
               {
                  _loc3_.callback = null;
               }
               delete var_239[_loc1_];
            }
            var_239 = null;
            var_69 = null;
            _disposed = true;
