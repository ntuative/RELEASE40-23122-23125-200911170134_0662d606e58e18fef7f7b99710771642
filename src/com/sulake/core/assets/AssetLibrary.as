package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1282:String = "AssetLibraryReady";
      
      public static const const_1221:String = "AssetLibraryUnloaded";
      
      public static const const_458:String = "AssetLibraryLoaded";
      
      public static const const_1099:String = "AssetLibraryLoadError";
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_381)
         {
            _loc4_ = AssetTypeDeclaration(var_381[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_449 = _loc2_.manifest.copy();
         var_330 = _loc2_.resource;
         if(var_448)
         {
            AssetLibrary.fetchLibraryContents(this,var_449,var_330);
         }
         var_286 = true;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_782,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_789,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_820,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_887,assetLoadEventHandler);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_381.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_381[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_381)
         {
            _loc3_ = AssetTypeDeclaration(var_381[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_849);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_449.child("library");
         if(_loc2_ == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_381[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
