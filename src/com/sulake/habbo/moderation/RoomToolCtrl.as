package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_946:ICheckBoxWindow;
      ...
      private var var_945:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_53,WindowTracker.const_688,_data.flatId),var_57,false,false,true);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new UserInfoFrameCtrl(var_53,_data.ownerId),var_57,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var_53.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1241,_loc2_,var_372.text,"",""));
         if(false)
         {
            var_53.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_946.isSelected,var_945.isSelected,var_638.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1155);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1197);
      }
      ...
      public function populate() : void
      {
         ...
         var_946 = ICheckBoxWindow(var_57.findChildByName("lock_check"));
         var_945 = ICheckBoxWindow(var_57.findChildByName("changename_check"));
         ...
         var_53.disableButton(var_53.initMsg.bobbaFilterPermission,var_57,"bobba_filter_but");
      ...
      {
         var_57 = IFrameWindow(var_53.getXmlWindow("roomtool_frame"));
         var_53.messageHandler.addRoomInfoListener(this);
         var_53.connection.send(new GetModeratorRoomInfoMessageComposer(var_399));
