package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1154:int = 6;
      ...
      public static const const_1288:int = 8;
      
      public static const const_981:int = 5;
      
      public static const const_1279:int = 1;
      
      public static const const_1103:int = 2;
      ...
      {
         var _loc2_:Dictionary = var_1484[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1484[param1] = _loc2_;
         }
         return _loc2_;
      }
