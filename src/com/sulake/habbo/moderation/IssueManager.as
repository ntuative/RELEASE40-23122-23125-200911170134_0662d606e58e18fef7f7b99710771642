package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_852:String = "issue_bundle_open";
      
      public static const const_577:String = "issue_bundle_my";
      ...
      private var var_498:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_125 = new Map();
         var_708 = new Map();
         var_498 = new IssueBrowser(this,var_61.windowManager,var_61.assets);
         var_587 = [];
         var_707 = [];
         var_870 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_870.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_587 = var_587.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_708.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_125)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_708.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_708.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_145)
         {
            ...
            _loc8_ = var_707.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_870.remove(param1);
         var_870.add(param1,_loc3_);
      ...
      {
         var _loc2_:* = var_870.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_61.soundManager.playSound(HabboSoundTypesEnum.const_913);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_708.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_125.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_404 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
