package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new ModActionCtrl(var_53,_data.userId,_data.userName),_callerFrame,var_959,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_53,WindowTracker.const_981,_data.userId),_callerFrame,var_959,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new RoomVisitsCtrl(var_53,_data.userId),_callerFrame,var_959,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_53.windowTracker.show(new SendMsgsCtrl(var_53,_data.userId,_data.userName),_callerFrame,var_959,false,true);
      }
