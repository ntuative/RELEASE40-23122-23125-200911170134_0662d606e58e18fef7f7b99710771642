package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1555:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_220:ITabContextWindow;
      
      private var var_1378:PickedIssuesView;
      
      private var var_317:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_317.view.width = var_220.container.width;
         var_317.view.height = var_220.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1555:
               if(var_1380 == null)
               {
                  var_1380 = new MyIssuesView(issueManager,this,var_220.container);
               }
               return var_1380;
            case const_1556:
               if(var_1379 == null)
               {
                  var_1379 = new OpenIssuesView(issueManager,this,var_220.container);
               }
               return var_1379;
            case const_1554:
               if(var_1378 == null)
               {
                  var_1378 = new PickedIssuesView(issueManager,this,var_220.container);
               }
               return var_1378;
            default:
               return null;
