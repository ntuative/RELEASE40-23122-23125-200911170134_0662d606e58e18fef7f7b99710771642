package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_740 = IWindowContainer(var_53.getXmlWindow("chatlog_roomheader"));
         var_739 = IWindowContainer(var_53.getXmlWindow("chatlog_chatline"));
         var_426 = new Timer(300,1);
         var_426.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_57 = IFrameWindow(var_53.getXmlWindow("chatlog_frame"));
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_740.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_57,var_53,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_739.clone());
         _loc4_.color = var_1109[param2.chatterId] != null ? (!!param3 ? 4293570819 : uint(4294955520)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_57,var_53,_loc6_,param2.chatterId);
         }
