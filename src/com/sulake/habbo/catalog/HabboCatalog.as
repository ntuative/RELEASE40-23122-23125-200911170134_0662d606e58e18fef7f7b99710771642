package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_640:PurchaseConfirmationDialog;
      ...
      private var var_379:ICatalogNavigator;
      ...
      {
         return var_505.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1907 && var_824 != null)
         {
            var_824.playSound(HabboSoundTypesEnum.const_824);
         }
         var_1907 = false;
      }
      ...
      {
         return var_505.getFurnitureData(param1);
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               var_1181 = param1.session.isPrivateRoom;
               if(var_91 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_379 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_640 == null)
            {
               var_640 = new PurchaseConfirmationDialog(_localization);
            }
            var_640.showOffer(this,param1,param2,param3);
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         {
            toggleCatalog(true);
            var_379.openPage(param1);
         }
      }
      
      private function setHabboToolbarIcon() : void
      {
         var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_379.buildCatalogIndex(_loc2_);
         if(var_949 != "")
         {
            var_379.openPage(var_949);
            var_949 = "";
         }
         else
         {
            var_379.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1908 && var_824 != null)
         {
            var_824.playSound(HabboSoundTypesEnum.const_781);
         }
         var_1908 = false;
      }
