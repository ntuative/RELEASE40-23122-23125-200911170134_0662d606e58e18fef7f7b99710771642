package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2210:String = "magic.pixels";
      
      private var var_2209:String = "catalog.page.club";
      ...
      {
         var_85.openCatalogPage(var_2209,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_85.loadCatalogPage(param1.pageId);
         var_85.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_85.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_85.loadCatalogPage(_loc2_.pageId);
         }
