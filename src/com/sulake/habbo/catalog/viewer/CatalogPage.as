package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1079:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_757:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_725);
      }
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1277 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1277) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1110) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1079;
            _loc2_.init();
         }
         var_1079.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1079.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_725);
      }
