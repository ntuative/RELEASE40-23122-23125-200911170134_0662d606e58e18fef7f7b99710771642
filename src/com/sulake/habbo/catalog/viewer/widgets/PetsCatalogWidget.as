package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_397 >= var_297.length)
         {
            return "";
         }
         var petColor:IPetColor = var_297[var_397] as IPetColor;
         var color:uint = petColor.rgb;
         var p:String = _name + String.fromCharCode(10) + addZeroPadding(String(var_1468),3) + String.fromCharCode(10) + addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_397 < 0 || var_397 > var_297.length)
         {
            var_397 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_896.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_257,onTextWindowEvent);
         var_896 = new Map();
         ...
         var_827 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_993 = 0;
         var_297 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_827);
               if(_loc11_)
               {
         ...
         {
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_827,_loc6_),getRaceLocalizationKey(var_827,_loc6_)));
            _loc6_++;
         }
         var_896.add(var_827,_loc5_);
      ...
      {
         var _loc6_:* = null;
         var _loc1_:Offer = var_896.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_397 >= 0 && var_397 < var_297.length)
         {
            _loc6_ = var_297[var_397] as IPetColor;
            if(_loc6_ != null)
            {
               _loc2_ = uint(_loc6_.rgb);
            }
         }
         var _loc3_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_827,var_1468,_loc2_,AvatarScaleType.const_50);
         if(_loc3_ == null)
         {
            return;
         }
         _loc3_.initActionAppends();
         _loc3_.appendAction(AvatarAction.const_287,AvatarAction.const_646);
