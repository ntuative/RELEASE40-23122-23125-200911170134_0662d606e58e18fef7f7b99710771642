package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1041:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1174.text = "${" + _loc3_.name + "}";
            var_1173.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1174.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_348:
                  _loc4_ = var_1042.clone();
                  if(var_494 != null)
                  {
                     var_494.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_494,var_1041,var_1283);
                  }
                  break;
               ...
               case Offer.const_382:
                  ...
                  switch(_loc6_.productType)
                  {
                     case ProductTypeEnum.const_150:
                        ...
                        break;
                     case ProductTypeEnum.const_130:
                     ...
                     case ProductTypeEnum.const_313:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_287,AvatarAction.const_528);
                              _loc13_.appendAction(AvatarAction.const_613,_loc6_.productClassId);
                        ...
                        break;
                     case ProductTypeEnum.const_551:
                        break;
                     default:
      ...
      {
         var_1174 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1173 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1300 = new Point(var_88.x,var_88.y);
         var_494 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1041 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_494 == null)
         {
         ...
         var_1042 = _loc2_.content as BitmapData;
