package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_174:String = "landscape";
      ...
      private var var_1097:String = "HelpViewController";
      
      private var var_1136:Array;
      
      private var var_926:BitmapData = null;
      
      private var var_221:int = 0;
      
      private var var_616:int = 0;
      
      private var var_1098:String = "1.1";
      ...
      private var _floorType:String = "HelpViewController";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_926 != null && var_925 != null)
         {
            setRoomImage(var_926,var_925);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_179.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_255];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_179.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_254];
               if(_loc13_ != null)
               {
                  var_1098 = _loc13_.@id;
               }
         ...
         switch(param1)
         {
            case const_176:
               ...
               for each(_loc8_ in var_179.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_615 = _loc8_.children().length();
                  }
               }
            ...
            case const_175:
               ...
               for each(_loc9_ in var_179.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_614 = _loc9_.children().length();
                  }
               }
            ...
            case const_174:
               ...
               for each(_loc10_ in var_179.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_616 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1097);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1134[var_280];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1098);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1097,var_1098,64,this,"window_romantic_wide");
