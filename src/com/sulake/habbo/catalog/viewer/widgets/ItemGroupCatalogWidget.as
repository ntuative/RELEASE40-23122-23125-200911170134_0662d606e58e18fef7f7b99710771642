package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_548[var_982] as Array;
      ...
      {
         var _loc2_:Offer = var_548[var_982][var_2032];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_438 || _loc1_.pricingModel == Offer.const_382)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_130 || _loc3_.productType == ProductTypeEnum.const_150)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (var_548[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_548)
         {
            if(var_2032 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2032] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_982 = var_853.getGridItemIndex(param1.view);
