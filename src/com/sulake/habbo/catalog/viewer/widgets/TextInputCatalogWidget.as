package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_977 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_977 != null)
         {
            var_977.addEventListener(WindowKeyboardEvent.const_807,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_977.text));
      }
   }
}
