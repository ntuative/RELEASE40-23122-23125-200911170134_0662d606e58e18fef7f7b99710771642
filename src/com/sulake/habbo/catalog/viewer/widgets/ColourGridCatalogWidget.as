package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         var_282 = null;
         for each(_loc1_ in var_1255)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1256) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1172.width,var_1172.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_942.width,var_942.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_942,var_942.rect,new Point(0,0),null,null,true);
