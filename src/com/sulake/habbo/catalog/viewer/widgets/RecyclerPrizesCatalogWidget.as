package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1283:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_757:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_622.length)
         {
            createLevelItem(var_622[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_757 = new PrizeViewer();
         var_896 = new Map();
         var_622 = recycler.getPrizeTable();
         if(var_622 == null)
         {
            return;
         }
         ...
         var_1826 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_622[0].prizes.length > 0)
         {
            select(var_622[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1826) as IWindowContainer;
      ...
      protected function method_10(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1283) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_757.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
