package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1077:IProductData;
      ...
      {
         super();
         var_1076 = param1.productType;
         var_1074 = param1.furniClassId;
         var_886 = param1.extraParam;
         var_885 = param1.productCount;
         var_1075 = param1.expiration;
         var_1077 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_130:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_886);
               break;
