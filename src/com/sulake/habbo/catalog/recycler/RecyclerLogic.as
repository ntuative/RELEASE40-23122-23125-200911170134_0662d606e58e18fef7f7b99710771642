package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1433)
         {
            case RecyclerStatusMessageEvent.const_1278:
               var_262 = const_335;
               if(_view == null)
               {
                  return;
               ...
               var_85.setupInventoryForRecycler(true);
               verifyRoomSessionStatus();
               updateRecyclerSlots();
               updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_787:
               if(_view == null)
               {
                  return;
               }
               _view.displayDisabledView();
               var_85.setupInventoryForRecycler(false);
               break;
      ...
      {
         var_262 = const_758;
         var_101 = new Array(const_151);
         if(param1 == null)
         {
            return;
         }
         _view = param1;
         var_85.getRecyclerStatus();
      }
      ...
      public function storePrizeTable(param1:Array) : void
      {
         ...
         {
            _loc3_ = new PrizeLevelContainer(param1[_loc2_],var_85);
            var_622.push(_loc3_);
            _loc2_++;
         }
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         var itemId:int = var_85.requestInventoryFurniToRecycler();
         if(itemId == 0)
         {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_921:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1123:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_85.returnInventoryFurniFromRecycler(var_101[param1].id))
         {
            return;
         }
         var_101[param1] = null;
