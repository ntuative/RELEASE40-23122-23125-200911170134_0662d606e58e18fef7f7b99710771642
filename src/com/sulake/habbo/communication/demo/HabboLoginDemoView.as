package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_309.shockwaveClientUrl = var_113.shockwaveClientUrl;
         var_309.ssoTicket = var_113.ticket;
         var_113.removeEventListener(SSOTicket.const_279,onParsedTicketSuccess);
         var_113.removeEventListener(SSOTicket.const_222,onParsedTicketFailure);
         var_113 = null;
      ...
      private function createWindow() : void
      {
         ...
         _window = var_309.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_315,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket() : void
      {
         ...
         var_113 = new SSOTicket(var_309.assets,_loc2_,_loc1_);
         var_113.addEventListener(SSOTicket.const_279,onParsedTicketSuccess);
         var_113.addEventListener(SSOTicket.const_222,onParsedTicketFailure);
      }
