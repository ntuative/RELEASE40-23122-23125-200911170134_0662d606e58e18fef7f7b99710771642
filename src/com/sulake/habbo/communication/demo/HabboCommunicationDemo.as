package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1968:PseudoRandom;
      ...
      private static function method_8(param1:ByteArray, param2:uint, param3:uint, param4:Point, param5:Point) : String
      {
         var _loc12_:int = 0;
         var _loc13_:* = 0;
         var _loc14_:int = 0;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_294:
               ...
               break;
            case DisconnectReasonEvent.const_896:
            ...
            case DisconnectReasonEvent.const_815:
               ...
               break;
            case DisconnectReasonEvent.const_912:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1969)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1209,var_1970));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_459.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_459.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1968);
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1970 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_174 == null)
         {
         ...
         if(var_656 != null)
         {
            var_77.mode = HabboConnectionType.const_460;
            var_77.initConnection(HabboConnectionType.const_230);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1968 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_77.mode)
         {
            case HabboConnectionType.const_460:
               _loc6_ = "";
               ...
               var_971 = _loc4_;
               var_174.loadBannerImage(_loc7_ + "?token=" + var_971,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1298:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1138:
               var_969 = generateRandomHexString(30);
               var_459 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_459.init(var_969);
               _loc8_ = var_459.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc3_:String = method_8(_loc2_,param1.width,4,new Point(4,39),new Point(80,30));
         ...
         var_459 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_969 = generateRandomHexString(30);
            var_459.init(var_969);
            _loc12_ = var_459.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
