package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      {
         if(var_168 != null && var_168.hasWorldType(const_267 + param1))
         {
            return var_168.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_629.indexOf(_loc14_) < 0)
                              {
                                 var_629.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_628.indexOf(_loc14_) < 0)
                              {
                                 var_628.push(_loc14_);
                              }
                           }
                           _loc16_ = var_436.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_436.remove(_loc14_);
                              var_436.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_374 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_374.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return [const_331,const_478,ROOM_CONTENT,const_740,const_739];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_374.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_522.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_374.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_436.getValue(param1));
         }
         return 0;
      }
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_148 && _loc5_ != RoomObjectLogicEnum.const_113)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1162);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_407,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_1856)
         {
            ...
            if(var_935 != null)
            {
               var_935.dispatchEvent(new Event(const_697));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_168 != null)
         {
            return var_168.getWorldHeightScale(const_267 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1857 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1852 = param2.getKey("public.room.dynamic.download.url","");
            var_1855 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_741;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_375 != null)
         {
            var_375.remove(param2);
            var_375.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_148 && _loc5_ != RoomObjectVisualizationEnum.const_113)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_267 + param1) == RoomObjectCategoryEnum.const_51)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_168 = _publicRooms.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_168 != null)
         {
            return var_168.getWorldScale(const_267 + param1);
         }
         return 32;
      }
