package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1374:int = 0;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = var_378.getValue(_loc4_) as IAvatarImage;
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_165);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_693);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_635);
         ...
         var _loc13_:Number = _loc7_ - var_1216;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_324);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_274 != _loc2_.getUpdateID() || var_206 != param1.scale || var_182 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_468 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_468;
            _loc22_ = getTimer();
            if(var_523 != _loc6_)
            {
               for each(_loc48_ in var_378.getKeys())
               {
                  var_378.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            {
               ...
               var_378.remove(_loc4_);
               var_378.add(_loc4_,_loc5_);
               var_523 = _loc6_;
            }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_273);
            ...
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_684);
            _loc5_.appendAction(AvatarAction.const_628,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_362);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_287,AvatarAction.const_1344[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_953);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_907,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_932);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_857);
               _loc54_ = 5;
            ...
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_664);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_717);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_925,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_901);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_790,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_413);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_411) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_709);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_462);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_911);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_613,_loc35_);
            }
            ...
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_783))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_378 != null)
         {
            _loc1_ = var_378.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_378.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
