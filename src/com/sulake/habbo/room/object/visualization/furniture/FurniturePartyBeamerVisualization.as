package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1030:int = 1;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_910[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_913[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_910 = new Array();
         var_910.push(Math.random() * _loc2_ * 1.5);
         var_910.push(Math.random() * _loc2_ * 1.5);
         var_911 = new Array();
         var_911.push(1);
         var_911.push(-1);
         var_912 = new Array();
         var_912.push(const_1029);
         var_912.push(const_1030);
         var_913 = new Array();
         var_913.push(getRandomAmplitudeFactor());
         var_913.push(getRandomAmplitudeFactor());
      }
