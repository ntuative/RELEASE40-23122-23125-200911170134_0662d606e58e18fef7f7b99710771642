package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1044:Number = 30;
      ...
      {
         var_625 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1208 = param3;
         var_1832 = param4 * 0 * 2 / 360;
         var_1393 = param5 * 0 * 2 / 360;
         _height = param6;
         var_762 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1208 * Math.cos(var_762 + var_1393);
         var _loc4_:Number = var_1208 * Math.sin(var_762 + var_1393);
         var _loc5_:Number = _height;
         var_625.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_625.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_625.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_625.add(param1);
         }
