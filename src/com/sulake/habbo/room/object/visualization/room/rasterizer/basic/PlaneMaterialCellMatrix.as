package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1244:int = const_283;
      ...
      public static const const_706:int = 6;
      
      public static const const_254:int = const_98;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1394 == const_98)
         {
            _loc5_ = new Rectangle(0,0,var_38.width,var_435);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_435,var_38.width,var_435);
         }
         ...
         if(isStatic)
         {
            if(var_38 != null)
            {
               if(var_38.width == param2 && var_38.height == param3 && Vector3d.isEqual(var_737,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_435,param6,param7);
                     return param1;
                  }
                  return var_38;
               }
