package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1284:int = 13421772;
      
      private static const const_1056:int = 16777215;
      
      public static const const_1119:int = 10066329;
      
      private static const const_1055:int = 13421772;
      ...
      public static const const_1342:int = 13421772;
      ...
      private var var_940:uint = 16777215;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1383;
               }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_514);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_509);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_647);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_817);
            if(_loc8_ != var_1876)
            {
               updatePlaneMasks(_loc8_);
               var_1876 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_654));
            if(_loc9_ != var_940)
            {
               var_940 = _loc9_;
            }
            var_1877 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_847));
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_174)
            {
               _loc12_ = uint(_loc11_.color);
               if(var_1877)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_940 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_940 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_940 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_942);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_792);
         var _loc7_:int = 0;
         while(_loc7_ < var_84.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_128)
            {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_174,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_174 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_111.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_247 || _loc3_.type == RoomPlane.const_174 && _loc8_ == RoomPlaneBitmapMaskData.const_201)
                  {
