package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_891:LayoutRasterizerData = null;
      ...
      private var var_417:Boolean = true;
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1080 = RoomObjectVariableEnum.const_926;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1080 = RoomObjectVariableEnum.const_848;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_892 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_892 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_892 + _adBgIndex);
            _loc5_ = param1.getSprite(var_892 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1080);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1609);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_593)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_891 = var_66.getValue(var_593);
         }
      }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_891.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_313.indexOf(_loc10_) >= 0 && var_417)
            {
               param1 = var_313.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_416[param1]);
                  if(_loc9_ != null)
                  {
                     param2.asset = _loc9_.asset;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_418[param1];
               }
               var_313.splice(param1,1);
               var_416.splice(param1,1);
               var_418.splice(param1,1);
               if(false)
               {
                  var_417 = false;
               }
