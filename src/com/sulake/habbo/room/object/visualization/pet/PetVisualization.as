package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc11_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_841);
         if(_loc11_ > 0)
         {
            _loc16_ = getTimer() - _loc11_;
            if(_loc16_ < AvatarAction.const_793)
            {
         ...
         var _loc14_:Boolean = var_274 != _loc2_.getUpdateID() || var_206 != param1.scale || var_182 != _loc3_.getUpdateID();
         var _loc15_:Boolean = _isAnimating || var_468 > 0 || _loc12_;
         if(_loc14_ || _loc15_)
         {
            _loc17_ = getTimer();
            --var_468;
            if(var_523 != _loc6_)
            {
               for each(_loc34_ in var_378.getKeys())
               {
                  var_378.remove(_loc34_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            ...
            _loc19_ = _loc3_.getNumber(RoomObjectVariableEnum.const_273);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc21_ = _loc3_.getString(RoomObjectVariableEnum.const_684);
            _loc5_.appendAction(AvatarAction.const_628,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
            ...
            {
               _loc36_ = _loc3_.getNumber(RoomObjectVariableEnum.const_362);
               _loc37_ = 3;
               _loc38_ = _loc7_ - _loc36_;
               if(_loc38_ < _loc37_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_287,_loc23_);
               }
            }
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_411) > 0;
            if(_loc24_)
            {
            ...
            _loc29_ = _loc5_.getSprites().length + const_1063;
