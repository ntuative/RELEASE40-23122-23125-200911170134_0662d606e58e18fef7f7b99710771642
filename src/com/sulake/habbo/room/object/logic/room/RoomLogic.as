package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1350:int = 255;
      
      private var var_1351:int = 255;
      
      private var var_1105:uint = 16777215;
      
      private var var_908:uint = 16777215;
      
      protected var var_84:RoomPlaneParser = null;
      
      private var var_734:int = 0;
      
      private var var_1178:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_403:
                  _loc8_ = "null";
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_817,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_847,int(_loc5_.bgOnly));
            var_1105 = _color;
            var_1350 = var_1178;
            var_908 = _loc11_;
            var_1351 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_942,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_654,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1205,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_128 || _loc13_ == RoomPlaneData.const_261)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_734)
         {
            ...
            {
               _loc6_ = var_1105 >> 16 & 255;
               _loc7_ = var_1105 >> 8 & 255;
               _loc8_ = var_1105 & 255;
               _loc9_ = var_908 >> 16 & 255;
               _loc10_ = var_908 >> 8 & 255;
               _loc11_ = var_908 & 255;
               _loc12_ = (_loc1_ - var_734) / var_1352;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1350 + (var_1351 - var_1350) * _loc12_;
               _color = _loc2_;
               var_1178 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_654,_loc2_);
         }
      }
   }
}
