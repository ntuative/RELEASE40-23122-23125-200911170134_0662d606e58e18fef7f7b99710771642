      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_367:
               ...
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_538);
            ...
            case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REMOVE_DIMMER:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_858));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_640,RoomWidgetDimmerSavePresetMessage.const_610,RoomWidgetDimmerChangeStateMessage.const_622,RoomWidgetDimmerPreviewMessage.const_618];
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetDimmerSavePresetMessage.const_610:
               if(validateRights())
               {
                  ...
                  _container.roomSession.method_14(_loc5_.presetNumber,_loc5_.effectTypeId,_loc5_.color,_loc5_.brightness,_loc5_.apply);
               }
               break;
            case RoomWidgetDimmerChangeStateMessage.const_622:
               if(validateRights())
               {
                  _container.roomSession.sendRoomDimmerChangeStateMessage();
               }
               break;
            case RoomWidgetDimmerPreviewMessage.const_618:
