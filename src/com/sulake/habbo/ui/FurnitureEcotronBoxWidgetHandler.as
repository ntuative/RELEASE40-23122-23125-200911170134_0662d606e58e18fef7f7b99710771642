package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_665,RoomWidgetEcotronBoxOpenMessage.const_502,RoomWidgetEcotronBoxOpenedMessage.const_1249];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_665:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_502:
