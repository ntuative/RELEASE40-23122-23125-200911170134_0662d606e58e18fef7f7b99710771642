package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_771:Number = 0;
      
      private var var_441:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_439 != null)
         {
            ...
            {
               _loc2_ = var_439.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_439.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_633.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_439.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_633.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_560,RoomWidgetChatSelectAvatarMessage.const_512];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_560:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_132,_container.roomSession,0,"Version 23122-23125-200911170109");
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_470);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_771 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_771);
            }
            if(var_441 == null)
            {
               var_440.x = 0;
               var_440.y = 0;
               var_440.z = 0;
               var_441 = _loc4_.getScreenPoint(var_440);
               var_771 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_440.x = 0;
            var_440.y = 0;
            var_440.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_440);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_441.x || _loc8_.y != var_441.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_441,_loc5_));
