   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_95:
               ...
               break;
            case HabboHelpTutorialEvent.const_363:
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_599,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_363,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_599,onFigureUpdate);
         }
         var_28 = _container.inventory;
         if(var_28 != null)
         {
            (var_28 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_776,onAvatarEffectsChanged);
            (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_535,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_363,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_95,onHelpTutorialEvent);
         }
         var_85 = _container.catalog;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_569);
         _loc1_.push(RoomWidgetDanceMessage.const_707);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_521);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_699);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_594);
         _loc1_.push(RoomWidgetStopEffectMessage.const_633);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1254);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_889);
         _loc1_.push(RoomWidgetToolbarMessage.const_623);
         _loc1_.push(RoomWidgetToolbarMessage.const_530);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_534);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1280);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_825);
         ...
         _loc1_.push(RoomWidgetGetSettingsMessage.const_619);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_495));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_649:
               ...
               break;
            case RoomWidgetWaveMessage.const_569:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_707:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_521:
               if(var_28 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_710:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_594:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_85 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_527)
               {
                  var_85.openCatalogPage(CatalogPageName.const_282,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_699:
               ...
               if(var_28 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_856:
                        var_85.openCatalogPage(CatalogPageName.const_1172,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_888:
                        var_28.toggleInventoryPage(InventoryCategory.const_258);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1323:
                        var_28.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1209:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_633:
            ...
            case RoomWidgetSetToolbarIconMessage.const_897:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1191:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_889:
            ...
            case RoomWidgetToolbarMessage.const_623:
               ...
               if(var_189)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_28 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_530:
               _loc6_ = param1 as RoomWidgetToolbarMessage;
               if(var_189)
               {
                  var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_449,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_534:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_396,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_978));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_396,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1220));
                     }
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_714:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_619:
