package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1018:int = -16;
      
      private static const const_727:int = 32;
      
      private static const const_1017:int = 8;
      
      public static const const_395:int = 10;
      ...
      private var var_714:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_714 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_714.getImage(ThumbnailEditorModel.const_31,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1018,_loc4_.y + const_1016 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1558[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_714.getImage(ThumbnailEditorModel.const_34,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_714.getImage(ThumbnailEditorModel.const_34,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_714.getImage(ThumbnailEditorModel.const_52,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_727 / 2);
         return new Point(param1 * const_727 + _loc3_,param2 * const_1017);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_395)
         {
            if(false)
            {
               refreshObj(param1,var_874[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1054 == null)
         {
            var_1054 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1054,var_1054.rect,new Point(0,0),null,null,true);
      }
   }
}
