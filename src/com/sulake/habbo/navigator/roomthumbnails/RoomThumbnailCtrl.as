package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this.var_87.mode != ThumbnailEditorModel.const_34);
         setEnabled(var_1290,this.var_87.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1291,this.var_87.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_87.mode = ThumbnailEditorModel.const_34;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_87.mode = ThumbnailEditorModel.const_52;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1290 = IButtonWindow(find("top_tab"));
         var_1291 = IButtonWindow(find("obj_tab"));
         var_1510 = IWindowContainer(find("tile_grid"));
         var_1509 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1290,onTopTabButton);
         Util.setProcDirectly(var_1291,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1510;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_395)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1509;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_54,HabboWindowStyle.const_38,HabboWindowParam.const_65,new Rectangle(0,0,param1.width,66)));
