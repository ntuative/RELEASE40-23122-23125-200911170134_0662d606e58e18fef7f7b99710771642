package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_434:IDropMenuWindow;
      
      private var var_2220:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_620;
         }
         if(param1 == 2)
         {
            return Tabs.const_536;
         }
         if(param1 == 3)
         {
      ...
      {
         var _loc1_:int = var_434 == null ? 0 : int(var_434.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_245,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_434 == null)
         {
            var_434 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_434.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
