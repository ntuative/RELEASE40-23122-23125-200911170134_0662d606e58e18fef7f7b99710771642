package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_445:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_445 == null ? 0 : int(var_445.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_219,Tabs.const_302);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_219,Tabs.const_523);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_219,Tabs.const_302,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_445 == null)
         {
            var_445 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_445.procedure = onChangeFilter;
