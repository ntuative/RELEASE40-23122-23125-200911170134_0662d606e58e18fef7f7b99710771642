package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1486:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_204,Tabs.const_191,"-1",MainViewCtrl.const_552);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1486 == null)
         {
            ...
            var_1486 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1486.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
