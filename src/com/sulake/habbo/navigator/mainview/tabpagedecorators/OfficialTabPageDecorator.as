package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class OfficialTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_235,Tabs.const_450,"" + _loc2_,MainViewCtrl.const_487);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_452 == null)
         {
            var_452 = IDropMenuWindow(_loc3_.findChildByName("officialSubNavi"));
            var_452.procedure = onChangeNavi;
            prepareNavi();
         }
         _loc3_.visible = true;
      }
