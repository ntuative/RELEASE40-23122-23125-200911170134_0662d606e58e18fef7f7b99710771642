package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements ICoreUpdateReceiver
   {
      ...
      public static const const_487:int = 4;
      ...
      private static const const_482:int = 22;
      ...
      private var var_1426:GuestRoomListCtrl;
      ...
      private var var_1424:OfficialRoomListCtrl;
      
      private var var_33:IWindowContainer;
      
      private var var_1425:PopularTagsListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1425 = new PopularTagsListCtrl(_navigator);
         var_1426 = new GuestRoomListCtrl(_navigator);
         var_1424 = new OfficialRoomListCtrl(_navigator);
      ...
      private function prepare() : void
      {
         ...
         var_220 = ITabContextWindow(var_27.findChildByName("tab_context"));
         ...
         var_1193 = IRegionWindow(var_27.findChildByName("to_hotel_view"));
         ...
         var_27.scaler.setParamFlag(HabboWindowParam.const_572,false);
         var_27.scaler.setParamFlag(HabboWindowParam.const_1207,true);
      }
      ...
      {
         refreshScrollbar(var_1425);
         refreshScrollbar(var_1426);
         refreshScrollbar(var_1424);
      }
      ...
      {
         refreshList(param1,param2,var_1424,"official_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         refreshList(param1,param2,var_1425,"popular_tags");
      }
      
      private function refreshGuestRooms(param1:Boolean, param2:Boolean) : void
      {
         refreshList(param1,param2,var_1426,"guest_rooms");
      }
      ...
      public function refresh() : void
      {
         ...
         var_200.height = var_200.height + _loc1_ - 0 - 0 + var_1927;
         Util.moveChildrenToColumn(var_33,["list_content","custom_footer"],var_200.y,8);
         var_1927 = var_259.height;
         onResizeTimer(null);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_385 == const_749)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_200.blend - _loc2_));
            this.var_200.blend = _loc3_;
            this.var_226.blend = !!var_1195 ? Number(_loc3_) : Number(1);
            this.var_259.blend = !!var_1195 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               var_385 = const_485;
            }
         }
         else if(var_385 == const_485)
         {
            if(var_1194 % 10 == 1)
            {
               var_12.visible = true;
