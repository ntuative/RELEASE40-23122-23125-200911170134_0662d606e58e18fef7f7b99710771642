package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2101:ISessionDataManager;
      
      private var var_2099:RoomCreateViewCtrl;
      
      private var var_1996:RoomThumbnailRenderer;
      
      private var var_189:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1262:RoomInfoViewCtrl;
      
      private var var_85:IHabboCatalog;
      
      private var var_376:Tabs;
      
      private var var_479:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_479 = new MainViewCtrl(this);
         var_1262 = new RoomInfoViewCtrl(this);
         var_2099 = new RoomCreateViewCtrl(this);
         var_1996 = new RoomThumbnailRenderer(this);
         var_1001 = new GuestRoomPasswordInput(this);
         var_316 = new GuestRoomDoorbell(this);
         var_376 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_479.startSearch(Tabs.const_204,Tabs.const_306,param1);
         var_479.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_189 != null)
         {
            var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2101 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_479.startSearch(Tabs.const_245,Tabs.const_190);
         var_376.getTab(Tabs.const_245).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_479.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
