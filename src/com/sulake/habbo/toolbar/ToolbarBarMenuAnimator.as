package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1060:Number = 90;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_455.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_455.splice(_loc3_,1);
            var_454.splice(_loc3_,1);
         }
         var_454.push(param1.name);
         var_455.push(param2);
      ...
      {
         return param1.x + param1.width < const_757 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_757 || param1.desktop.height - param1.y < const_1069;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_454[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
