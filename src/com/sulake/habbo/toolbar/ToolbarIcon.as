package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         _events = param5;
         var_334 = param6;
         var_1210 = new Timer(40,40);
         var_1210.addEventListener(TimerEvent.TIMER,updateBouncer);
         var_102 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_386,HabboWindowStyle.const_39,HabboWindowParam.const_35,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1438[var_975.indexOf(param1)];
      }
      ...
      {
         return var_543.indexOf(param1) > -1;
      }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_808[var_543.indexOf(param1)];
      ...
      private function setTooltip() : void
      {
         ...
         {
            var_102.toolTipCaption = "${toolbar.icon.tooltip." + var_1993.toLowerCase() + "}";
         }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_334 != null)
         {
            var_334.animateWindowIn(this,param1,param2,var_807,param3,param4,getMenuYieldList(param1));
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         var_975 = new Array();
         var_1993 = param1.@id;
         var_1992 = int(param1.@window_offset_from_icon);
         var_1991 = int(param1.@window_margin);
         var _loc2_:XMLList = param1.elements("state");
         if(_loc2_.length() > 0)
         {
            if(param1.attribute("state_over").length() > 0)
            {
               var_973 = param1.@state_over;
            }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_334 != null)
         {
            var_334.hideWindow(param1,param2,var_807,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_334 != null)
         {
            var_334.positionWindow(this,param1,param2,var_807,param3,getMenuYieldList(param1));
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         if(_loc1_ != null && var_976)
         {
            ...
            var_390 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_89,_y,_bitmapData);
            if(false)
            {
      ...
      {
         return var_1991 + var_463.windowMargin;
      }
