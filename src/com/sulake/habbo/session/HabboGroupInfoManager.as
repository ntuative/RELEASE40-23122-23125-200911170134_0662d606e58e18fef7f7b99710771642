package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = var_257.getValue(_loc2_.groupId);
         var_943[_loc2_.groupId] = _loc3_;
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(var_257.getValue(_loc4_) != null)
            {
               var_257.remove(_loc4_);
            }
            var_257.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      {
         return var_257.getValue(param1);
      }
      ...
      {
         var _loc2_:HabboGroupDetails = var_943[param1];
         if(_loc2_ == null)
         {
