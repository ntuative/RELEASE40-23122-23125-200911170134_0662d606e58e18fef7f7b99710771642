   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1164,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1312,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_542,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_802,String(0));
         }
      ...
      {
         var_85 = IHabboCatalog(param2) as IHabboCatalog;
         var_85.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_85.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_85.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_179)
         {
            Component(var_179).events.addEventListener(HabboConfigurationEvent.const_15,onConfigurationLoaded);
            if(var_234 != null)
            {
               var_234.configuration = var_179;
            }
            if(var_233 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_471.events.addEventListener(AdEvent.const_349,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_802,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_542,String(true));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_471)
            {
               var_471.release(new IIDHabboAdManager());
               var_471 = null;
            }
            if(_navigator)
            {
            ...
            if(var_85)
            {
               if(true)
               {
                  var_85.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_85.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_85.release(new IIDHabboCatalog());
               var_85 = null;
            }
            if(var_28)
            {
            ...
            if(var_178)
            {
               if(true)
               {
                  ...
                  Component(var_178).events.removeEventListener(HabboFriendListTrackingEvent.const_321,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_351,onLagWarningEvent);
               }
            }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_351:
               var_1264.registerWarning(LagWarningLogger.const_985);
         }
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_179)
         {
            Component(var_179).events.removeEventListener(HabboConfigurationEvent.const_15,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_351,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_178).events.addEventListener(HabboFriendListTrackingEvent.const_321,onFriendlistTrackingEvent);
      }
