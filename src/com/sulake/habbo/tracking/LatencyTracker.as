package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1338 = getTimer();
         var_425.add(var_1102,var_1338);
         _connection.send(new LatencyPingRequestMessageComposer(var_1102));
         ++var_1102;
      }
      ...
      public function init() : void
      {
         ...
         var_1340 = int(var_179.getKey("latencytest.interval"));
         var_1339 = int(var_179.getKey("latencytest.report.index"));
         var_1677 = int(var_179.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(var_425 == null || var_152 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = var_425.getValue(_loc2_.requestId);
         var_425.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         var_152.push(_loc4_);
         if(var_152.length == var_1339 && var_1339 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1341) > var_1677 || var_1341 == 0)
            {
               var_1341 = _loc9_;
