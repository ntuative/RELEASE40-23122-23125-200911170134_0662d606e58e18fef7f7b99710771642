package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1270:IWindowContainer;
      
      public static var var_1015:int = 6710886;
      ...
      private var var_1395:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1270 == null)
         {
            ...
            var_1270 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1496 == null)
         {
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_906 != null)
         {
            toggleCategoryView(var_906,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1395 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_906 = param1;
         var_1395.setSelected(var_1395.getSelectableByName(param1));
         _window.invalidate();
      }
