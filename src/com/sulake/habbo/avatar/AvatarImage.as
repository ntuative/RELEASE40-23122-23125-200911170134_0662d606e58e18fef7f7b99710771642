package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1051:String = "Default";
      
      private static const const_1049:int = 125;
       
      
      private var _avatarSubType:int = 0;
      
      private var var_523:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         var_523 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_523.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_936;
         }
         var_132 = new AvatarImageCache(var_83,this,_assets,var_195);
         setDirection(const_1052,const_1050);
         var_194 = new Array();
         resetActions();
      }
      ...
      {
         param2 += var_1159;
         if(param2 < AvatarDirectionAngle.const_1225)
         {
            param2 = AvatarDirectionAngle.const_636 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_636)
         {
            param2 -= NaN;
         }
         if(var_835 == AvatarType.PET && param1 == AvatarSetType.const_45)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_83.sortActions(var_194);
         if(_loc1_ == null)
         {
         ...
         {
            var_524 = var_83.getCanvasOffsets(_loc1_,var_195,var_100);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            {
               _isAnimating = true;
               _loc3_ = var_83.getAnimation(_loc2_.definition.state + "." + _loc2_.actionParameter);
               if(_loc3_ != null)
               {
                  var_172 = var_172.concat(_loc3_.spriteData);
                  if(_loc3_.hasDirectionData())
                  {
                     var_1159 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_522)
            {
               _isAnimating = true;
            }
      ...
      {
         return var_83.getPartColor(var_523,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_83.getCanvas(var_195,var_169.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_83.getBodyParts(param1,var_169.definition,var_100);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_437);
            if(_loc10_ != null)
            {
               ...
               if(var_835 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_83.getParts(_loc9_,var_523,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_195 == AvatarScaleType.const_90)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_437);
                     _loc21_ = var_100;
                     _loc22_ = 1;
                     switch(var_100)
                     {
                     ...
                     _loc23_ = var_83.getPartActionOffset(getSubType(),var_195,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_83.getCanvas(var_195,var_169.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_83.getBodyParts(param1,var_169.definition,var_100);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_437);
            if(_loc8_ != null)
            {
               ...
               if(var_835 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_83.getParts(_loc7_,var_523,_loc12_,"pet",_loc11_.getDirection());
                  _loc15_ = 32;
                  if(var_195 == AvatarScaleType.const_90)
                  {
                     _loc15_ = 6;
                  ...
                  {
                     _loc16_ = _loc14_[0];
                     _loc17_ = _loc16_.getFrameIndex(var_437);
                     _loc18_ = var_100;
                     _loc19_ = 1;
                     switch(var_100)
                     {
                     ...
                     _loc20_ = var_83.getPartActionOffset(getSubType(),var_195,_loc7_,_loc13_,_loc17_,_loc18_);
                     if(_loc20_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_169.definition = var_83.getActionDefinition(const_1051);
      ...
      {
         return var_83.getBodyPartData(param1.animation.id,var_437,param1.id);
      }
            ...
            case AvatarAction.const_628:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1132:
                     if(var_835 == AvatarType.const_97)
                     {
                        if(var_100 == 0)
                        {
