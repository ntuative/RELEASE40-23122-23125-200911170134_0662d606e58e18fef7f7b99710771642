package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_83.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_648)
               {
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_83.getParts(param1,(var_812 as AvatarImage).getFigure(),_loc6_,var_1154,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_83.getCanvas(var_195,var_1154);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1156[param1])
            {
            ...
            else
            {
               ...
               {
                  _loc34_ = var_83.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc32_ == AvatarAction.const_803 || _loc32_ == AvatarAction.const_522) && (_loc6_ == AvatarBodyPartType.const_310 || _loc6_ == AvatarBodyPartType.const_1335 || _loc6_ == AvatarBodyPartType.const_1313) && _loc7_.color != null)
               {
