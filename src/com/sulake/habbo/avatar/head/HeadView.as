package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      private var var_432:IWindowContainer;
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_674["null"] = new AvatarEditorGridView(param1,FigureData.const_102,param2,param3);
         var_674["null"] = new AvatarEditorGridView(param1,FigureData.const_125,param2,param3);
         var_674["null"] = new AvatarEditorGridView(param1,FigureData.const_137,param2,param3);
         var_674["null"] = new AvatarEditorGridView(param1,FigureData.const_126,param2,param3);
         var_674["null"] = new AvatarEditorGridView(param1,FigureData.const_139,param2,param3);
         attachImages();
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1015);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_674[var_1382];
         if(_loc2_ == null)
         {
            return;
         }
