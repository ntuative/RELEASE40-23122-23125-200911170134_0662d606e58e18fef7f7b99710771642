package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_895:String = "AVATAR_STRUCTURE_DONE";
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            var_1439 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         var_2004.append(var_1439);
         dispatchEvent(new Event(AvatarStructureDownload.const_895));
      }
   }
}
