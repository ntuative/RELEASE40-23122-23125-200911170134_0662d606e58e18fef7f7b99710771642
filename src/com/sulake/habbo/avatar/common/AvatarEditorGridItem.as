package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1551:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1320:BitmapData;
      
      private const const_1552:int = 13421772;
      
      private var var_720:Rectangle;
      
      private var _window:IWindowContainer;
      
      private var var_883:Boolean;
      
      private var var_349:BitmapData;
      
      private var _color:IPartColor;
      
      private var var_87:IAvatarEditorCategoryModel;
      
      private var var_501:IFigurePartSet;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_349 = new BitmapData(1,1,true,16777215);
         }
         else
         {
            var_883 = param3.isColorable;
         }
         var_883 = param5;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            if(var_349 != null)
            {
               _loc2_ = var_349.clone();
               if(_color != null && var_883)
               {
         ...
         if(var_501 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1320,var_1320.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1552;
         }
         else
         {
            _window.color = const_1551;
         }
         _window.invalidate();
      }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_720.width,var_720.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_873 + "_" + FigureData.const_263;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_883 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_873 + "_" + FigureData.const_263;
