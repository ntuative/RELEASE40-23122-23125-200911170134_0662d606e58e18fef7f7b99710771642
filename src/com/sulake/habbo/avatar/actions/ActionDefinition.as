package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1428 = new Dictionary();
         super();
         _id = String(param1.@id);
         _state = String(param1.@state);
         var_1933 = parseInt(param1.@precedence);
         var_1935 = String(param1.@activepartset);
         var_1938 = String(param1.@assetpartdefinition);
         var_1939 = String(param1.@lay);
         var_1154 = String(param1.@geometrytype);
         var_1508 = Boolean(parseInt(param1.@main));
         var_1937 = Boolean(parseInt(param1.@HelpViewController));
         var_1936 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "HelpViewController")
            {
               var_1934 = _loc6_;
            }
            else
            {
               var_1428[_loc5_] = _loc6_;
            }
         }
