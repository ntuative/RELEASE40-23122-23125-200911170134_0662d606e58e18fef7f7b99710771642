package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_967.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_966)
         {
            ...
            var_655["null"] = new FigureData(this);
            var_655["null"] = new FigureData(this);
            _loc1_ = var_655["null"];
            _loc2_ = var_655["null"];
            ...
            var_322 = new Map();
            var_322.add(AvatarEditorCategory.const_805,new GenericModel(this));
            var_322.add(AvatarEditorCategory.const_45,new HeadModel(this));
            var_322.add(AvatarEditorCategory.const_310,new TorsoModel(this));
            var_322.add(AvatarEditorCategory.const_1214,new LegsModel(this));
            var_322.add(AvatarEditorCategory.const_494,new WardrobeModel(this));
            var_966 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_322.getValue(AvatarEditorCategory.const_494);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_322.getValue(AvatarEditorCategory.const_494);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_967.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1270.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1243)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1270.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_322.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_389 == null)
            {
               var_389 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_54,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_389.addChild(_view.window);
               var_389.center();
               var_389.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_805);
         if(var_179 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1033 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_535,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_967 = var_1033.getFigureData(AvatarType.const_97);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_968 = param3;
         var _loc4_:FigureData = var_655[param2];
         if(_loc4_ == null)
         {
            return;
         }
