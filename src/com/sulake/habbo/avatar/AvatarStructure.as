package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2086:PartOffsetData;
      ...
      private var var_1478:AvatarStructureDownloadSet;
      
      private var var_836:AvatarActionManager;
      
      private var var_161:IAssetLibrary;
      
      private var var_476:FigureData;
      
      private var var_2195:IAssetLibrary;
      
      private var var_1280:Boolean = false;
      
      private var var_679:AnimationManager;
      
      private var var_2085:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_161 = param2;
         var_2195 = param3;
         var_476 = new FigureData();
         var_400 = new PartSetsData();
         _animationData = new AnimationData();
         var_1478 = new AvatarStructureDownloadSet();
         var_679 = new AnimationManager();
         var_835 = param4;
         var_2086 = PartOffsetData.getInstance(param3);
      }
      
      public function getBodyParts(param1:String, param2:IActionDefinition, param3:int) : Array
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1235[param3];
      ...
      {
         return var_836.getActionDefinitionWithState(param1);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_679.getAnimation(param1);
      }
      ...
      public function init(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_835)
         {
            case AvatarType.const_97:
               ...
               if(!var_476.parse(_loc5_))
               {
                  return;
               }
               var_1478.add(new AvatarStructureDownload(var_161,_loc2_,var_476));
               _loc6_ = true;
               break;
            case AvatarType.PET:
         ...
         if(_loc6_)
         {
            var_1478.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
         }
         else
         {
            onStructureReady();
      ...
      {
         return var_836.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_836.getActionDefinition(param1);
      }
      
      private function initActions() : void
      {
         var_836 = new AvatarActionManager(var_161,var_835);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_679.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_836.getDefaultActionType();
         var _loc7_:Array = var_400.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_679.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_476.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_476.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_400.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_400.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_161.hasAsset("dance" + _loc1_))
         {
            ...
            var_679.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_476.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_476.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_835 + " ready to go!");
      ...
      {
         return var_836.sortActions(param1);
      }
   }
}
