package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1089 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_442 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_442.bitmap = new BitmapData(var_442.width,var_442.height,true,16777215);
         var_442.bitmap.copyPixels(var_1089,var_1089.rect,new Point(0,0 - 0 - 8));
         var_442.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
