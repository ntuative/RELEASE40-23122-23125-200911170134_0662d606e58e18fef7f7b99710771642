package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1617:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_349,0,0,_loc4_,var_1327,var_1618,var_1617));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1615 = int(_config.getKey("interstitial.interval","30000"));
         var_1616 = int(_config.getKey("interstitial.show.time","5000"));
         var_1326 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1083 = _loc2_.imageUrl;
         var_1327 = _loc2_.clickUrl;
         if(var_1083 != "" && var_1327 != "")
         {
            _loc3_ = var_1083;
            ...
            _loc4_ = new URLRequest(var_1083);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1084 = _loc2_.imageUrl;
         var_1614 = _loc2_.clickUrl;
         var_594 = getTimer();
         if(var_1084 != "")
         {
            _loc3_ = var_1084;
            ...
            var_213.start();
            _loc4_ = new URLRequest(var_1084);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_341,0,0,param1.bitmapData,var_1614));
            var_594 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1617 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1326 > 0 && var_1325 >= var_1326)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_594;
         if(_loc1_ > var_1615)
         {
            ++var_1325;
