package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1334:uint = 13232628;
      
      private static var var_1659:uint = 11129827;
      ...
      private var var_730:NameSuggestionListRenderer;
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         var_730 = new NameSuggestionListRenderer(var_53);
         var _loc6_:int = var_730.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1334;
