package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1695:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23122-23125-200911170109");
         var_189 = param5;
         var_115 = new Map();
         var_115.add(HabboHelpViewEnum.const_1258,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_144,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_358,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_241,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_205,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_518,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_309,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_584,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_181,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.CALL_FOR_HELP_PENDING_ITEM,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_115.add(HabboHelpViewEnum.const_516,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_250 == HabboHelpViewEnum.const_144 || false)
         {
            return;
         }
         if(var_366 == null)
         {
            ...
            var_366 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_366 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_366 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_366 as IWindow);
      ...
      {
         return var_115.getValue(var_250);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_115.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_115.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_1697 = param1;
         var _loc2_:IHelpViewController = var_115.getValue(HabboHelpViewEnum.const_144) as IHelpViewController;
      ...
      {
         var _loc3_:* = null;
         if(var_250 == HabboHelpViewEnum.const_144)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_366.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1354;
         _window.width = _loc1_.width + var_1353;
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_115.length)
         {
            _loc3_ = var_115.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_189 != null)
            {
               var_189.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_44,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_41.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_715));
      }
