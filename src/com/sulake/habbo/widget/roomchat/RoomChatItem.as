package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_328:int = 10;
      
      private static const const_1019:Number = 18;
      ...
      {
         _widget.onItemMouseOut(var_880,var_881,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_880,var_881,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1068 = param1.chatType;
         var_880 = param1.userId;
         var_719 = param1.userName;
         var_881 = param1.userCategory;
         _message = param1.text;
         var_1067 = param1.userX;
         var_187 = param1.userImage;
         var_882 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_882 != 0)
            {
               _loc31_ = uint(var_882 >> 16 & 255);
               _loc32_ = uint(var_882 >> 8 & 255);
               _loc33_ = uint(var_882 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_328;
            }
            else
            {
               _loc19_.text = var_719 + ":";
               _loc19_.y += var_358;
               _loc19_.width = _loc19_.textWidth + const_328;
               _width += _loc19_.textWidth + const_328;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1068 == RoomWidgetChatUpdateEvent.const_250)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_719);
            }
            else if(var_1068 == RoomWidgetChatUpdateEvent.const_260)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_719);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_328 + _loc20_.textWidth + const_474;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_880,var_881,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_880,var_881,_roomId,_roomCategory,param1);
      }
