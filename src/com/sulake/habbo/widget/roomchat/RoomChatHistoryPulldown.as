package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_42 = param3;
         var_1742 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1365 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1737 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1364 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1363 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1741 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1740 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_76 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_38,HabboWindowParam.const_65,new Rectangle(0,0,param3.width,param3.height - const_68),null,0,0) as IBitmapWrapperWindow;
         var_42.addChild(var_76);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_54,HabboWindowStyle.const_38,HabboWindowParam.const_35,new Rectangle(0,0 - const_68,param3.width,const_68),null,0) as IWindowContainer;
         var_42.addChild(_window);
         var_102 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_386,HabboWindowStyle.const_39,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_68),null,0) as IRegionWindow;
         if(var_102 != null)
         {
      ...
      public function update(param1:uint) : void
      {
         switch(state)
         {
            case const_376:
               ...
               break;
            case const_764:
               var_76.blend = 0 - param1 / const_735;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_102 != null)
         {
            ...
            var_102.width = 0 - var_1739;
         }
         if(var_76 != null)
         {
            var_76.rectangle = var_42.rectangle;
            var_76.height = 0 - const_68;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1738 == _window.width)
         {
            return;
         }
         var_1738 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1742.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1365.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1365.clone(),_loc9_);
