package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1053:XML;
      
      private var var_397:int;
      
      private var var_415:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1557:int;
      
      private var var_310:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_54,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_996,const_999,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_415 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_310 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_415 != null)
         {
            var_415.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_310 != null)
         {
            var_310.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_873 = _loc2_.light;
         if(var_310 != null)
         {
            var_310.setValue(var_873);
         }
         var_397 = colors.indexOf(_loc2_.color);
         if(var_415 != null)
         {
            var_415.setSelectedColorIndex(var_397);
         }
