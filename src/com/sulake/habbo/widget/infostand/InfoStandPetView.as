package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1568:String = "nutrition";
      ...
      private const const_1569:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_264:PetCommandTool;
      
      private const const_1562:uint = 11184810;
      
      private const const_1567:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_210 != null)
         {
            var_106 = var_210.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_106 == null || var_210 == null || var_65 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1052.getValue(var_814) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1567,param1.experience,param1.experienceMax);
         updateStateElement(const_1566,param1.energy,param1.energyMax);
         updateStateElement(const_1568,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_814 = param1.id;
         var_1052.remove(param1.id);
         var_1052.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1565,const_1569,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1562);
