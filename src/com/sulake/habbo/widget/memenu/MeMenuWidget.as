package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_503:String = "me_menu_settings_view";
      
      private static const const_738:int = 10;
      
      public static const const_508:String = "me_menu_effects_view";
      
      public static const const_117:String = "me_menu_top_view";
      
      public static const const_1307:String = "me_menu_rooms_view";
      
      public static const const_891:String = "me_menu_dance_moves_view";
      
      public static const const_224:String = "me_menu_my_clothes_view";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_660,onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_550,onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_525,onToolbarClicked);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_291,onUpdate);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_495,onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_396,onShowAvatarEditorClubPromo);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(var_40.window.name == const_503)
         {
      ...
      {
         var _loc2_:* = null;
         if(!(var_256 && var_40.window.name == const_224))
         {
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_660,onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_550,onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_525,onToolbarClicked);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_291,onUpdate);
         ...
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_495,onAvatarEditorClosed);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_396,onShowAvatarEditorClubPromo);
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_366:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + var_256 + " view: " + var_40.window.name);
               if(var_256 != true || var_40.window.name != const_117)
               {
                  return;
               }
               (var_40 as MeMenuMainView).setIconAssets("clothes_icon",const_117,"clothes_highlighter_blue");
               break;
      ...
      {
         var _loc2_:RoomWidgetToolbarMessage = new RoomWidgetToolbarMessage(RoomWidgetToolbarMessage.const_530);
      ...
      {
         var _loc2_:* = var_1143 > 0;
         var_1143 = param1.daysLeft;
         var_1839 = param1.periodsLeft;
         var_1841 = param1.pastPeriods;
         var_1837 = param1.allowClubDances;
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("me_menu_main_container","",HabboWindowType.const_1266,HabboWindowStyle.const_814,HabboWindowParam.const_39,new Rectangle(0,0,170,260)) as IWindowContainer;
      ...
      {
         if(var_40 != null && var_40.window.name != const_224)
         {
            hide();
         }
      }
      ...
      private function onShowAvatarEditorClubPromo(param1:RoomWidgetAvatarEditorUpdateEvent) : void
      {
         ...
         if(var_40 != null && var_40.window.name == const_224)
         {
            if(param1.promoMode == RoomWidgetAvatarEditorUpdateEvent.const_978)
            {
               var_96 = new ClubPromoView(this,param1.promoImageUrl,ClubPromoView.const_1273);
            }
            else
            {
               var_96 = new ClubPromoView(this,param1.promoImageUrl,ClubPromoView.const_455);
            }
            _loc2_ = _mainContainer.getChildByName(var_40.window.name);
            if(_loc2_ != null)
            {
               var_96.window.x = _loc2_.width + const_738;
      ...
      private function onUpdateEffects(param1:RoomWidgetUpdateEffectsUpdateEvent) : void
      {
         ...
         if(var_40 != null && var_40.window.name == const_508)
         {
      ...
      public function updateSize() : void
      {
         if(var_40 != null)
         {
            var_933.x = var_40.window.width + 10;
            var_933.y = var_40.window.height;
            var_40.window.x = 5;
            var_40.window.y = 0;
            _mainContainer.width = var_933.x;
            _mainContainer.height = var_933.y;
            if(var_96 != null)
            {
               _mainContainer.width = var_96.window.x + var_96.window.width + const_738;
            }
         }
      }
