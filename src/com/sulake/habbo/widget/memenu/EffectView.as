   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_775 = _window.findChildByName("effect_hilite");
            var_775.visible = false;
         }
         var_774 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_776 = _window.findChildByName("loader_bar");
         if(var_776 != null)
         {
            var_392 = var_776.width;
            var_173.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_774 != null)
         {
            var_774.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_774.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
