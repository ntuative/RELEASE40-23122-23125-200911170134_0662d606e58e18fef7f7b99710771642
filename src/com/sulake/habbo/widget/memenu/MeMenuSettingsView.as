package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_667:MeMenuSettingsViewSlider;
      
      private var var_1456:BitmapData;
      
      private var var_1453:BitmapData;
      
      private var var_666:Number = 1;
      ...
      {
         var_666 = param1.volume;
         if(var_667 != null)
         {
            var_667.setValue(var_666);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_667 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_619));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1455);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1454);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1456);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1453);
