      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_891);
               break;
            case "wave":
               if(false)
               {
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_508);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_888));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_224);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_527));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_503);
               break;
            default:
