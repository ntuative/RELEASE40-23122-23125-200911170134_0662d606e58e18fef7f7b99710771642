package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_226:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_675:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1317:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  ...
                  case "poll_offer_button_cancel":
                     _state = const_675;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_340,_id));
