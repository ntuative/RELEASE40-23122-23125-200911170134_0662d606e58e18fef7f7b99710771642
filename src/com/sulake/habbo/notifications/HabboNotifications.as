package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_991:String = "badges";
      
      private static const const_989:String = "pixelbalance";
      
      private static const const_993:String = "credits";
      
      private static const const_988:String = "inventory";
      
      private static const const_994:String = "friendlist";
      
      private static const const_990:String = "selectfurni";
      
      private static const const_992:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_490:ParkBusDialogManager;
      
      private var var_1034:IHabboToolbar;
      
      private var var_353:HabboNotificationViewManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_690);
         }
         var _loc6_:Map = var_690["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1124);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_921)
         {
            return;
         }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1287);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1505)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_779);
            var_1505 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1033.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_906,_loc5_);
         }
      }
      ...
      {
         if(var_353.isSpaceAvailable() && false)
         {
            var_353.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_490 == null)
         {
            var_490 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_490 != null)
         {
            var_490.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_862.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1033.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:BitmapData = var_505.getBadgeImage(_loc2_.badgeID);
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1188,_loc4_,_loc2_.badgeID);
         }
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_196 || param2.type == WindowEvent.const_588)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc16_ = var_505.getProductData(_loc15_.productType);
               _loc17_ = var_505.getFurnitureData(_loc15_.furniClassId);
               _loc7_ = var_505.getProductData(_loc4_.localizationId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_779,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1033.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      {
         var_1034 = IHabboToolbar(param2);
         var_1034.events.addEventListener(HabboToolbarEvent.const_76,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_192);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_505.userId == _loc2_.userId)
         {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_76)
         {
            ...
            var_353 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_690["styles"],var_690["view"],var_1034);
            ...
            registerUpdateReceiver(var_353,1);
            registerUpdateReceiver(this,2);
            var_505.events.addEventListener(BadgeImageReadyEvent.const_149,onBadgeImage);
            var_1034.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
