package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategories
   {
      ...
      private function updateCategories(param1:Array) : void
      {
         ...
         var _loc5_:* = null;
         flushReceivedStatus();
         findCategory(FriendCategory.const_463).received = true;
         findCategory(FriendCategory.const_851).received = true;
      ...
      private function removeFriend(param1:int, param2:Boolean) : Boolean
      {
         ...
         if(param2)
         {
            var_1032[param1] = null;
         }
         var _loc3_:Boolean = false;
         for each(_loc4_ in var_322)
         {
      ...
      {
         var _loc2_:int = !!param1.online ? int(param1.categoryId) : int(FriendCategory.const_463);
         var _loc3_:FriendCategory = findCategory(_loc2_);
         if(_loc3_ != null)
         {
            _loc3_.addFriend(param1);
            var_1032[param1.id] = param1;
            return _loc3_;
         }
