package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1515:int = "F".charCodeAt(0);
      
      public static const const_1385:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_1130 = param1.followingAllowed && param1.online;
         var_523 = param1.figure;
         var_1157 = param1.motto;
         var_1155 = param1.lastAccess;
         var_1158 = param1.categoryId;
