package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_304:int = 100;
      ...
      {
         return Math.ceil(this.var_208.length / const_304);
      }
      ...
      {
         if(this.var_695 >= this.getPageCount())
         {
            this.var_695 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_695 + 1) * const_304,this.var_208.length);
      }
