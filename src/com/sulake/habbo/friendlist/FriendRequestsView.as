package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1359:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_290 && _loc4_.state != FriendRequest.const_305)
            {
      ...
      {
         var_1389 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1390 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1390.procedure = onDismissAllButtonClick;
         var_1389.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_924)
         {
