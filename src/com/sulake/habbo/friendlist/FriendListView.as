package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1356:String = "noconvinfo";
      
      private static const const_1357:String = "messageinput";
      ...
      private var var_1119:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1119 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_738 = IWindowContainer(var_27.content.findChildByName("main_content"));
         var_259 = IWindowContainer(var_27.content.findChildByName("footer"));
         var_1119.prepare(var_738);
         var_27.procedure = onWindow;
         var_27.content.setParamFlag(HabboWindowParam.const_980,false);
         var_27.content.setParamFlag(HabboWindowParam.const_1223,true);
         var_27.header.setParamFlag(HabboWindowParam.const_570,false);
         var_27.header.setParamFlag(HabboWindowParam.const_773,true);
         var_27.content.setParamFlag(HabboWindowParam.const_570,false);
         var_27.content.setParamFlag(HabboWindowParam.const_773,true);
         var_27.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1118 = ITextWindow(var_27.findChildByName("info_text"));
         var_1118.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_27.scaler.setParamFlag(HabboWindowParam.const_954,this._friendList.tabs.findSelectedTab() != null);
         var_27.scaler.setParamFlag(HabboWindowParam.const_570,false);
         var_27.scaler.setParamFlag(HabboWindowParam.const_980,false);
         var_27.scaler.x = 0 - var_27.scaler.width;
         var_27.scaler.y = 0 - var_27.scaler.height;
         var_1367 = var_27.height;
         var_1368 = var_27.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1367 == -1 ? 0 : int(0 - var_1367);
         var _loc4_:int = var_1368 == -1 ? 0 : int(0 - var_1368);
