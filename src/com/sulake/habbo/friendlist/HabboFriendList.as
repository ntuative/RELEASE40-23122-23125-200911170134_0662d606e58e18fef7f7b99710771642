package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1633:IAvatarRenderManager;
      
      private var var_1330:AvatarSearchResults;
      
      private var var_127:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_729:FriendRequests;
      
      private var var_1630:int;
      
      var var_322:FriendCategories;
      
      private var var_189:IHabboToolbar;
      
      private var var_1632:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_376:FriendListTabs;
      
      private var var_1631:IHabboNotifications;
      ...
      {
         var_1632 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_322 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1330 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_729.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_729.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_376.findTab(FriendListTab.const_100).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_147,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_729.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_322.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_729 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_322.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_322.addCategory(new FriendCategory(FriendCategory.const_851,getText("friendlist.friends")));
         var_322.addCategory(new FriendCategory(FriendCategory.const_463,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_322.addFriend(new Friend(_loc4_));
         }
         var_376 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_189.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_322.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_77);
      ...
      {
         var _loc2_:IAvatarImage = var_1633.createAvatarImage(param1,AvatarScaleType.const_90);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1633 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_729.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_376.findTab(FriendListTab.const_100);
      ...
      {
         var_1631 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_322.getFriendCount(param1,param2);
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_376.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1330.searchReceived(_loc2_.friends,_loc2_.others);
