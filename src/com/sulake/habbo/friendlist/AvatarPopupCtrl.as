package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1156 != "")
         {
            friendList.refreshText(param1,"name_text_online",var_632,var_1156);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",var_632,var_1401);
         }
         friendList.refreshText(param1,"name_text_offline",!var_632,var_1401);
         friendList.refreshText(param1,"motto_text",var_632,var_1868);
         friendList.refreshButton(param1,"offline",!var_632,null,0);
         if(var_632)
         {
            refreshFigure(param1,var_1869);
