package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1429:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1202));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1429[var_1202]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
