package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_489:String = "bg";
      ...
      private var var_1703:IContainerButtonWindow;
      ...
      {
         var_1701 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1702 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1704 = initButton("room_invite",onInviteButtonClick,param1);
         var_1703 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_489);
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_77,param4);
         _loc6_.visible = true;
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_332.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess,_loc3_.realName);
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1701,isEnableMinimailButton(_loc1_));
         setEnabled(var_1702,isEnableHomeButton(_loc1_));
         setEnabled(var_1704,isEnableInviteButton(_loc1_));
         setEnabled(var_1703,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_489);
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_77,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_77).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_77,param1);
      }
