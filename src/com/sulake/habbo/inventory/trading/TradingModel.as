package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1139:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_414 = false;
         var_589 = false;
         var_51.updateItemList(var_588);
         var_51.updateItemList(var_1047);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_51.alertPopup(TradingView.const_950);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_588)
            {
               var_414 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_589 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_51.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_588)
            {
               var_51.alertPopup(TradingView.const_835);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_414 + " OTHER: " + var_589);
         ...
         {
            case const_160:
               if(param1 == const_154 || param1 == const_199)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_51.setMinimized(param1 != InventoryCategory.const_78);
      ...
      public function close() : void
      {
         if(var_502)
         {
            if(_state != const_160 && _state != const_199)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_160;
            var_28.toggleInventorySubPage(InventorySubCategory.const_914);
            var_502 = false;
         }
         var_51.setMinimized(false);
      }
