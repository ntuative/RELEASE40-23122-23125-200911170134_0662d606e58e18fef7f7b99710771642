package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_756:uint = 4284532064;
      
      private static const const_755:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_939)
            {
            ...
            var_332.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_394);
            var_332.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1427 == null)
         {
            var_1427 = createMinimizedWindow();
         }
         if(!var_1928)
         {
            return var_67;
      ...
      private function method_7() : IWindowContainer
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc6_:int = 0;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_756) : uint(const_755);
            }
