package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_963:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_540 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_540.width;
         var_97 = var_540.height;
         var_964 = param5;
         var_796 = param6;
         var_229 = Math.floor(var_964 / _thumbWidth);
         var_32 = new BitmapData(var_964,var_796);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_32.height < var_796)
         {
            _loc12_ = new BitmapData(var_32.width,var_796);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_540.width,var_540.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_540.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_540,var_540.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_963 != null)
         {
            _loc1_ = var_963.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_456 = resolveRowCountFromList();
         if(var_456 == 0)
         {
            var_32 = new BitmapData(var_964,var_796);
            return;
         }
         var_32 = new BitmapData(Math.max(var_229 * _thumbWidth,var_964),Math.max(var_456 * var_97,var_796),true,16777215);
         var_32.fillRect(var_32.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_456)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_229 && var_32.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_229 - 1),var_97);
         ...
         _loc4_ = new Rectangle(0,var_97,_thumbWidth * (var_229 - 1),0 - var_97);
