package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2143:BitmapData;
      
      protected var var_858:Boolean;
      ...
      protected var var_349:BitmapData;
      
      private const const_1376:Number = 0.2;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_661)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(var_2144 == FurniModel.const_40)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this);
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1278);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1376;
               _loc1_.blend = const_1376;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1287 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2143;
               _loc5_.visible = true;
            }
            else
            {
