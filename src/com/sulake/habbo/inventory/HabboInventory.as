package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1550:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            ...
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_451,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_451:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_56.getValue(InventoryCategory.const_616));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_56.getValue(InventoryCategory.const_78));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_776));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_56.getValue(InventoryCategory.const_259));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1550);
         }
      }
      ...
      {
         return AchievementsModel(var_56.getValue(InventoryCategory.const_277));
      }
      ...
      {
         return TradingModel(var_56.getValue(InventorySubCategory.const_256));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_505 = ISessionDataManager(param2);
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1312 = new IncomingMessages(this);
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_451,roomSessionEventHandler);
         ...
         var_56.add(InventoryCategory.const_78,_loc3_);
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_505);
         var_56.add(InventoryCategory.const_258,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_56.add(InventoryCategory.const_616,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_505);
         var_56.add(InventoryCategory.const_277,_loc6_);
         var _loc7_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_56.add(InventorySubCategory.const_256,_loc7_);
         ...
         var_56.add(InventoryCategory.const_259,_loc9_);
