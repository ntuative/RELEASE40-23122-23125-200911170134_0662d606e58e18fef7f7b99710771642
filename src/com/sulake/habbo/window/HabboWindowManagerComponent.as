package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1151:ProfilerAgentTask;
      
      private var var_1152:IEventDispatcher;
      
      private var var_2223:uint = 0;
      
      private var var_1150:ProfilerAgentTask;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1152 = Component(param1).events;
            var_764 = new Array();
      ...
      {
         return var_283[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_283[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_283 = new Array(const_330);
         var _loc6_:int = 0;
         while(_loc6_ < const_330)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_627,this,_localization,var_188,new Rectangle(0,0,var_188.stageWidth,var_188.stageHeight),this);
            var_283[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_389 = var_283[const_1045];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_389.getMouseCursor().defineCustomCursorType(MouseCursorType.const_298,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_389.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1204,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_283[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_283.pop()).dispose();
            }
            if(var_1153 != null)
            {
               var_1153.dispose();
      ...
      {
         return var_283[param1].getDesktopWindow().getChildAt(var_389.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1153 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1153 = new ProfilerOutput(_loc3_,this,var_627);
               var_1151 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1151);
               var_1150 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1150);
               var_934 = true;
            }
         }
      }
      ...
      {
         return var_389.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1152.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_330 - 1;
            while(_loc2_ >= 0)
            {
               var_283[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_934)
         ...
         var_1152.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_330)
         {
            var_283[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_934)
         {
         ...
         var_1152.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_764[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_764[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_389.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1117,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1331,param2.name + ": " + param2.toString());
            }
         }
      }
   }
