package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_571:Number = 64;
      ...
      private var var_1348:Number = 1;
      
      private var var_2201:Number = 500;
      
      private var var_1349:Number = 1;
      
      private var var_89:Vector3d;
      
      private var var_90:Vector3d;
      
      private var var_2202:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_90 = new Vector3d();
         var_907 = new Vector3d();
         var_1347 = 1;
         var_1349 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1348 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_363 != param1 * var_1348)
         {
            var_363 = param1 * var_1348;
            ++var_82;
         }
      }
      ...
      {
         if(var_365 != param1 * var_1347)
         {
            var_365 = param1 * var_1347;
            ++var_82;
         }
      }
      ...
      {
         if(var_364 != param1 * var_1349)
         {
            var_364 = param1 * var_1349;
            ++var_82;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_362 != null)
         {
            ...
            var_362.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_362.add(_loc3_,_loc4_);
            ++var_82;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_907.assign(_loc22_);
         }
         else
         {
            var_907.assign(_loc17_);
         }
         ++var_82;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_364;
         _loc2_.z *= var_363;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_907);
         if(_loc3_ < var_2202 || _loc3_ > var_2201)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_364;
            _loc2_.z *= var_363;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_907);
         }
      ...
      {
         return new Vector3d(0 * var_365,0 * var_364,0 * var_363);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_362 != null)
         {
            ...
            return var_362.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_365,0 * var_364,0 * var_363);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_90;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_365,param2.y * var_364,param2.z * var_363);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_365,param3.y * var_364,param3.z * var_363);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_365,param4.y * var_364,param4.z * var_363);
