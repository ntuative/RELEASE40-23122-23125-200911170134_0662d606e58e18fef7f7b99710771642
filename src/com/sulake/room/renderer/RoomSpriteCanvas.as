package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_845:RoomObjectLocationCache;
      ...
      private var var_2118:Number = -10000000;
      
      private var var_2117:Number = -10000000;
      ...
      private var var_1010:IRoomRenderingCanvasMouseListener = null;
      
      private var var_1012:Point;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_845 = new RoomObjectLocationCache(_loc6_);
         var_301 = new Map();
      ...
      public function update() : void
      {
         if(var_1009 == 0)
         {
            checkMouseHits(var_1012.x,var_1012.y,MouseEvent.MOUSE_MOVE);
         }
         var_1009 = 0;
      }
      ...
      {
         var _loc11_:Number = param1 - var_1013 / 2;
         var _loc12_:Number = param2 - var_1011 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc4_ < var_146.length)
         {
            var_146.splice(_loc4_);
         }
         var _loc8_:String = " ";
         if(true)
         {
         ...
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorting sprites" + _loc8_ + var_146.length);
         var_146.sortOn("z",0 | 0);
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorted sprites" + _loc8_ + var_146.length);
         var _loc9_:* = null;
         var _loc10_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < _loc4_)
         {
            _loc9_ = var_146[_loc3_] as SortableSprite;
            updateSprite(_loc3_,_loc9_);
            _loc9_.bitmapData = null;
            _loc3_++;
         }
         cleanSprites(var_146.length);
         var_2119 = param1;
         ...
         while(_loc1_ < var_301.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1010 != null)
                  {
                     var_1010.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1494,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_146.length)
         {
            return null;
         }
         return var_146[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_481.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_481.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2118 || param2 != var_2117)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_481.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_481.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int) : int
      {
         ...
         var _loc6_:IVector3d = var_845.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc7_ += int(var_1013 / 2);
         _loc8_ += int(var_1011 / 2);
         var _loc10_:int = 0;
         var _loc11_:* = null;
         var _loc12_:* = null;
         var _loc13_:int = 0;
            ...
            if(_loc12_ != null && _loc12_.visible)
            {
               ...
               if(_loc16_ != null)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     ...
                     if(_loc13_ + _loc18_.width >= 0 && _loc13_ < var_1013 && (_loc14_ + _loc18_.height >= 0 && _loc14_ < var_1011))
                     {
                        if(param3 + _loc10_ < var_146.length)
                        {
                           _loc11_ = var_146[param3 + _loc10_];
